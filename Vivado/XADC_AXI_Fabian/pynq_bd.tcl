...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:user:AXI_Stream_ADC:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set Vaux1_0_v_n [ create_bd_port -dir I Vaux1_0_v_n ]
  set Vaux1_0_v_p [ create_bd_port -dir I Vaux1_0_v_p ]

  # Create instance: AXI_Stream_ADC_0, and set properties
  set AXI_Stream_ADC_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:AXI_Stream_ADC:1.0 AXI_Stream_ADC_0 ]
...
\
  ...
  connect_bd_intf_net -intf_net AXI_Stream_ADC_0_M00_AXIS [get_bd_intf_pins AXI_Stream_ADC_0/M00_AXIS] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins xadc_wiz_0/daddr_in]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins AXI_Stream_ADC_0/m00_axis_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins xadc_wiz_0/dclk_in]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins AXI_Stream_ADC_0/m00_axis_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net vauxn1_0_1 [get_bd_ports Vaux1_0_v_n] [get_bd_pins xadc_wiz_0/vauxn1]
  connect_bd_net -net vauxp1_0_1 [get_bd_ports Vaux1_0_v_p] [get_bd_pins xadc_wiz_0/vauxp1]
  connect_bd_net -net xadc_wiz_0_do_out [get_bd_pins AXI_Stream_ADC_0/data_in] [get_bd_pins axi_gpio_0/gpio2_io_i] [get_bd_pins xadc_wiz_0/do_out]
  connect_bd_net -net xadc_wiz_0_eoc_out [get_bd_pins AXI_Stream_ADC_0/clk_adc] [get_bd_pins xadc_wiz_0/eoc_out]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xadc_wiz_0/den_in] [get_bd_pins xlconstant_0/dout]
