...
#
# Generated by export_simulation on Sun Mar 17 21:22:28 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './pynq_bd.sh' script.

./pynq_bd.sh -reset_run
...
./pynq_bd.sh -noclean_files

For more information on the script, please type './pynq_bd.sh -help'.
