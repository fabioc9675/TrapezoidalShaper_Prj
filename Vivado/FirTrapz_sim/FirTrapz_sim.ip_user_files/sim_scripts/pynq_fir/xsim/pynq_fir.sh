...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L xil_defaultlib -L secureip -L xpm --snapshot pynq_fir xil_defaultlib.pynq_fir -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim  pynq_fir -key {Behavioral:sim_1:Functional:pynq_fir} -tclbatch cmd.tcl -protoinst "protoinst_files/pynq_fir.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb pynq_fir.wdb xsim.dir)
