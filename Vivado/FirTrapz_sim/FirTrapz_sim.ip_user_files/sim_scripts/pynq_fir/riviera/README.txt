...
#
# Generated by export_simulation on Sat Mar 09 12:29:01 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './pynq_fir.sh' script.

./pynq_fir.sh -reset_run
...
./pynq_fir.sh -noclean_files

For more information on the script, please type './pynq_fir.sh -help'.
