...
# module references:
# dpp_counter, dpp_leds, fir_fab, leds, trapz_klm
...
proc create_root_design { parentCell } {
  ...
  set led_rst_0 [ create_bd_port -dir O -type rst led_rst_0 ]
  ...
  set_property -dict [list \
    ...
    CONFIG.CLKOUT2_JITTER {132.637} \
    CONFIG.CLKOUT2_PHASE_ERROR {102.245} \
    CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {104.000} \
...
\
  ...
  set rst_clk_wiz_0_104M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_clk_wiz_0_104M ]
  ...
  connect_bd_intf_net -intf_net axis_subset_converter_0_M_AXIS [get_bd_intf_pins axi_dma/S_AXIS_S2MM] [get_bd_intf_pins axis_subset_converter_0/M_AXIS]
  ...
  connect_bd_net -net dpp_counter_0_led_rst [get_bd_ports led_rst_0] [get_bd_pins dpp_counter_0/led_rst]
  connect_bd_net -net dpp_counter_0_y [get_bd_pins dpp_counter_0/y] [get_bd_pins dpp_leds_0/x]
  connect_bd_net -net dpp_leds_0_led [get_bd_ports led_0] [get_bd_pins dpp_leds_0/led]
  connect_bd_net -net fir_fab_0_y [get_bd_pins fir_fab_0/y] [get_bd_pins trapz_klm_0/x]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dma/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins xadc_wiz_0/s_axis_aclk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins dpp_counter_0/ap_clk] [get_bd_pins fir_fab_0/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins trapz_klm_0/ap_clk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_dma/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net sw_0_1 [get_bd_ports sw] [get_bd_pins leds_0/sw]
  connect_bd_net -net trapz_klm_0_y [get_bd_pins dpp_counter_0/x] [get_bd_pins trapz_klm_0/y]
  connect_bd_net -net xadc_wiz_0_do_out [get_bd_pins fir_fab_0/x] [get_bd_pins leds_0/x] [get_bd_pins xadc_wiz_0/do_out]
  connect_bd_net -net xadc_wiz_0_eoc_out [get_bd_pins xadc_wiz_0/den_in] [get_bd_pins xadc_wiz_0/eoc_out]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins dpp_counter_0/fifo_en] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlslice_0_Dout [get_bd_ports led_1] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins dpp_counter_0/ap_rst] [get_bd_pins fir_fab_0/ap_rst] [get_bd_pins trapz_klm_0/ap_rst] [get_bd_pins xlconstant_1/dout]
