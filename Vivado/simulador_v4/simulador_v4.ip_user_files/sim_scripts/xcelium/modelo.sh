...
#
# Script generated by Vivado on Sun Oct 06 09:48:26 -0500 2024
...
#
# Usage        : modelo.sh
#                modelo.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                modelo.sh [-reset_run]
#                modelo.sh [-reset_log]
#                modelo.sh [-help]
#
...
#                script (type 'modelo.sh -help' for more information).
#
...
design_libs_elab="-libname xbip_utils_v3_0_13 -libname xbip_pipe_v3_0_9 -libname xbip_bram18k_v3_0_9 -libname mult_gen_v12_0_21 -libname xil_defaultlib -libname secureip"

# set design libraries
design_libs=(simprims_ver xbip_utils_v3_0_13 xbip_pipe_v3_0_9 xbip_bram18k_v3_0_9 mult_gen_v12_0_21 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "modelo.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./modelo.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.modelo
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.modelo -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log modelo_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./modelo.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: modelo.sh [-help]\n\
Usage: modelo.sh [-step]\n\
Usage: modelo.sh [-lib_map_path]\n\
Usage: modelo.sh [-reset_run]\n\
Usage: modelo.sh [-reset_log]\n\
Usage: modelo.sh [-keep_index]\n\
Usage: modelo.sh [-noclean_files]\n\n\
