...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_utils_v3_0_13 -L xbip_pipe_v3_0_9 -L xbip_bram18k_v3_0_9 -L mult_gen_v12_0_21 -L xil_defaultlib -L secureip --snapshot modelo xil_defaultlib.modelo -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim modelo -key {Behavioral:sim_1:Functional:modelo} -tclbatch cmd.tcl -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xbip_utils_v3_0_13 xbip_pipe_v3_0_9 xbip_bram18k_v3_0_9 mult_gen_v12_0_21)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb modelo.wdb xsim.dir libdpi.so)
