...
design_libs=(xbip_utils_v3_0_13 xbip_pipe_v3_0_9 xbip_bram18k_v3_0_9 mult_gen_v12_0_21 xil_defaultlib)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.modelo -o modelo_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./modelo_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key modelo_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc modelo_simv.daidir vcs_lib c.obj)
