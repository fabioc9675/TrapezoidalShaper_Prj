...
#set_property -dict { PACKAGE_PIN L15   IOSTANDARD LVCMOS33 } [get_ports { led_0_4 }]; #IO_L22N_T3_AD7N_35 Sch=led4_b
...
set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33 } [get_ports { out_trg_0 }]; #IO_L6N_T0_VREF_34 Sch=led[0]
